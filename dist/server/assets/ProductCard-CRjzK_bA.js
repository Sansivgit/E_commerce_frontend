...
import { u as useAuth, c as useCart, d as useNavigate, t as toast, f as formatInr, q as cn, B as Button, ai as requestAuthJson, l as loginSearch, s as safeRedirectPath, b as useWishlist, S as ShoppingBag, H as Heart, L as Link } from "./router-B5Ai9hSw.js";
import { o as orderedStandardSizes, r as resolveStoredSize } from "./sizes-BMKjk5Mb.js";
import { f as fetchAddresses, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, h as DialogDescription, L as Label, d as DialogFooter, I as Input, T as Textarea, e as createAddress } from "./addresses-l3B2FJ_g.js";
import { M as Minus, P as Plus, R as RadioGroup, a as RadioGroupItem, l as loadRazorpayScript } from "./radio-group-s09rzDrg.js";
...
function ProductQuickViewDialog({ product, open, onOpenChange }) {
  const { user, token } = useAuth();
  const { add } = useCart();
  const navigate = useNavigate();
  const [payStep, setPayStep] = reactExports.useState("product");
  const [qty, setQty] = reactExports.useState(1);
  const [size, setSize] = reactExports.useState("");
  const [colorName, setColorName] = reactExports.useState(product.colors[0]?.name ?? "Standard");
  ...
  const displaySizes = reactExports.useMemo(() => orderedStandardSizes(product.sizes), [product.sizes]);
  reactExports.useEffect(() => {
    if (!open) return;
    setPayStep("product");
    setQty(1);
  ...
  const startRazorpay = async () => {
    ...
    const razorpayKey = "rzp_test_Snh6GjGsBzuwL6";
    setPaying(true);
    try {
      const receipt = `qv_${product.id}`.replace(/[^a-zA-Z0-9_]/g, "").slice(0, 40);
      const order = await requestAuthJson("/api/payments/create-order", token, {
        method: "POST",
        body: {
          amount: totalInr,
          currency: "INR",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogContent, { className: "left-[50%] top-4 flex max-h-[92vh] w-[calc(100vw-1.5rem)] max-w-[960px] translate-x-[-50%] translate-y-0 flex-col gap-0 overflow-hidden border bg-background p-0 shadow-lg duration-200 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-top-[48%] sm:top-8 sm:rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-0 flex-1 overflow-y-auto overscroll-y-contain px-6 py-6 sm:px-8 sm:py-8 [scrollbar-gutter:stable]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "text-left space-y-1 pr-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-2xl uppercase", children: payStep === "product" ? "Quick view" : "Delivery & payment" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { className: "sr-only", children: [
        "Product details and checkout options for ",
        product.name
      ] })
    ] }),
    payStep === "product" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 grid gap-8 md:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] overflow-hidden rounded-lg bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-3xl uppercase leading-tight", children: product.name }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-semibold", children: formatInr(product.price) }),
          product.compareAt != null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground line-through text-sm", children: formatInr(product.compareAt) })
        ] }),
        product.colors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs uppercase tracking-widest font-display", children: "Color" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex flex-wrap gap-2", children: product.colors.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              className: cn(
                ...
                colorName === c.name ? "border-foreground bg-muted" : "border-border hover:border-muted-foreground"
              ),
              children: [
        ...
        displaySizes.length > 0 || product.sizes.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs uppercase tracking-widest font-display", children: "Size" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 grid grid-cols-4 sm:grid-cols-5 gap-2", children: (displaySizes.length > 0 ? displaySizes : product.sizes).map((canon) => {
            const stored = displaySizes.length > 0 ? resolveStoredSize(String(canon), product.sizes) ?? String(canon) : String(canon);
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: cn(
                  ...
                  size === stored ? "volt-primary-btn border-neutral-950 dark:border-neutral-50" : "border-border hover:border-muted-foreground"
                ),
                children: label
              },
              `${label}-${stored}`
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs uppercase tracking-widest font-display shrink-0", children: "Qty" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "flex-col sm:flex-row gap-2 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: onAddToCart, className: "w-full sm:flex-1 font-display uppercase tracking-widest", children: "Add to cart" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "ghost", size: "sm", className: "-mt-2 px-0", onClick: () => setPayStep("product"), children: "← Back to product" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
        "Choose where we should ship this order. Amount due: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: formatInr(totalInr) }),
        " (INR)."
      ] }),
      addrLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Loading addresses…" }) : addresses.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroup, { value: selectedAddrId, onValueChange: setSelectedAddrId, children: addresses.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "label",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: String(a._id), id: `addr-${a._id}`, className: "mt-1" }),
      ...
      addresses.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          type: "button",
          variant: "outline",
          ...
          children: expandNewAddress ? "Hide new address form" : "Add another address"
        }
      ) }),
      expandNewAddress && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border p-4 space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-3 sm:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 sm:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-label", children: "Label (optional)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-label",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-name", children: "Full name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-name",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-phone", children: "Phone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-phone",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 sm:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-line1", children: "Address line 1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-line1",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 sm:col-span-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-line2", children: "Address line 2 (optional)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: "qv-line2",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-city", children: "City" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-city",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-state", children: "State" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-state",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-postal", children: "Postal code" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-postal",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "qv-country", children: "Country" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "qv-country",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "secondary", onClick: submitNewAddress, disabled: savingAddr, children: savingAddr ? "Saving…" : "Save address" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { className: "flex-col sm:flex-row gap-2 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          type: "button",
          ...
          children: paying ? "Opening payment…" : `Proceed to pay ${formatInr(totalInr)}`
        }
      ) })
    ] })
  ] }) }) });
...
function ProductCard({ product, index = 0 }) {
  ...
  const onQuickAdd = (e) => {
    ...
    const storedPick = sizesShown.length > 0 ? resolveStoredSize(sizesShown[0], product.sizes) : void 0;
    const size = storedPick ?? product.sizes[0];
    const color2 = product.colors[0]?.name ?? "Standard";
    if (!size) {
      toast.error("Open product to choose options", { description: product.name });
      return;
    }
    add(product, size, color2, 1);
      ...
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative aspect-[4/5] overflow-hidden rounded-lg bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: product.images[0],
                alt: product.name,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 right-3 z-10 flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: "h-9 w-9 rounded-full bg-background/90 backdrop-blur flex items-center justify-center hover:bg-background transition-colors",
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: cn("h-4 w-4 transition-colors", wished && "fill-foreground text-foreground") })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pointer-events-none block bg-neutral-950 py-2.5 text-center text-xs font-display uppercase tracking-widest text-neutral-50 rounded-md dark:bg-neutral-900", children: "Quick view" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/products/$slug", params: { slug: product.slug }, className: "mt-3 flex items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: product.type }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium truncate", children: product.name })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: formatInr(product.price) }),
              product.compareAt && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground line-through", children: formatInr(product.compareAt) })
            ] })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProductQuickViewDialog, { product, open: quickOpen, onOpenChange: setQuickOpen })
  ] });
}
function ProductCardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-pulse", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[4/5] rounded-lg bg-muted" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 h-3 w-1/3 bg-muted rounded" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 h-4 w-2/3 bg-muted rounded" })
  ] });
}
export {
  ProductCard as P,
  ProductCardSkeleton as a,
  motion as m
};
