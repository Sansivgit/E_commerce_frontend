...
import { e as createLucideIcon, u as useAuth, c as useCart, d as useNavigate, t as toast, f as formatInr, B as Button, ai as requestAuthJson, a as useRouterState, s as safeRedirectPath, N as Navigate, l as loginSearch, S as ShoppingBag, L as Link } from "./router-B5Ai9hSw.js";
import { B as Breadcrumbs } from "./Breadcrumbs-sSG1XxUH.js";
import { E as EmptyState } from "./EmptyState-BItGhwp4.js";
import { f as fetchAddresses, D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, h as DialogDescription, L as Label, I as Input, T as Textarea, d as DialogFooter, e as createAddress } from "./addresses-l3B2FJ_g.js";
import { R as RadioGroup, a as RadioGroupItem, l as loadRazorpayScript, M as Minus, P as Plus } from "./radio-group-s09rzDrg.js";
import { A as ArrowRight } from "./arrow-right-DUmummKv.js";
...
function buildOrderLines(cartItems, subtotal, discountAmt, shipping, total) {
  const ratio = subtotal > 0 && discountAmt > 0 ? (subtotal - discountAmt) / subtotal : 1;
  ...
  if (Math.abs(drift) > 1e-3 && lines.length > 0) {
